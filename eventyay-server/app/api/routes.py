...
from app.api.partner_organizations import (
    PartnerOrganizationDetail,
    PartnerOrganizationList,
    PartnerOrganizationListPost,
    PartnerOrganizationRelationshipOptional,
    PartnerOrganizationRelationshipRequired,
)
...
# Partner Organizations (Erasmus+ Youth Exchanges)
api.route(
    PartnerOrganizationListPost,
    'partner_organization_list_post',
    '/partner-organizations',
)
api.route(
    PartnerOrganizationList,
    'partner_organization_list',
    '/events/<int:event_id>/partner-organizations',
    '/events/<event_identifier>/partner-organizations',
)
api.route(
    PartnerOrganizationDetail,
    'partner_organization_detail',
    '/partner-organizations/<int:id>',
    '/attendees/<int:attendee_id>/partner-organization',
)
api.route(
    PartnerOrganizationRelationshipRequired,
    'partner_organization_event',
    '/partner-organizations/<int:id>/relationships/event',
)
api.route(
    PartnerOrganizationRelationshipOptional,
    'partner_organization_attendees',
    '/partner-organizations/<int:id>/relationships/attendees',
)
api.route(
    PartnerOrganizationRelationshipOptional,
    'attendee_partner_organization',
    '/attendees/<int:id>/relationships/partner-organization',
)
